...
public class EmpresaController {
    ...
    @PostMapping("/criar")
    public ResponseEntity<Empresa> criarEmpresa(@RequestBody Empresa empresa, Departamento departamento) {
        var novaEmpresa = empresaService.criarEmpresa(empresa, departamento);
